	...
	)
{
	...
	{
		case 0:
		{//error: unknown command ! OK //////////
			cout << "error: invalid command !" << endl;
			break;
		};
		case 1:
		{//error: at least filename should be specified. OK ////////////
			cout << "error: at least filename should be specified." << endl;
			break;
		};
		case 2:
		{//wref563r  is not a valid initial amount.
		 //Creating my.wallet aborted. OK //////////////
		...
		case 3:
		{//error: could not create my.wallet OK //////////
			cout << "error: could not create '" << parameter1 << "'."
			<< endl;
			break;
		};
		case 4:
		{//error: wallet my.wallet already exists! OK //////////////////
		...
		case 6:
		{//my.wallet created with the initial amount of +55.00 RON OK
		...
		case 8://error: invalid parameters for <comm> OK ///////
		{
			cout << "error: invalid parameters for '" << parameter1 
			<< "'." << endl;
			break;
		};
		case 9://Spending 'other' in an amount of 145.12 RON was registered. OK
		{////////////////////////
		...
		case 11: //error: income should be higher than 0. OK ///////////
		{
			if(parameter1 == "spend")
			{
				parameter1 = "spending";
		...
		case 13: //error: could not open 'moneytracker.config' OK ///////////
		{
		...
		case 15: //Balance for clothes in my.wallet is +900.00 RON OK
		{//////////////////////////
			if(parameter1 == "")
			{
